...
# centre; Z is elevation above the inclined ground at that Y coordinate.
export MOUND_GEM_IN1_WIDTH_M="1"
export MOUND_GEM_IN1_HEIGHT_M="1"
export MOUND_GEM_IN1_Y_M="-27"
export MOUND_GEM_IN1_Z_M="1"
export MOUND_GEM_IN2_WIDTH_M="1"
export MOUND_GEM_IN2_HEIGHT_M="1"
export MOUND_GEM_IN2_Y_M="-23"
export MOUND_GEM_IN2_Z_M="1"
export MOUND_GEM_OUT1_WIDTH_M="1"
export MOUND_GEM_OUT1_HEIGHT_M="1"
export MOUND_GEM_OUT1_Y_M="23"
export MOUND_GEM_OUT1_Z_M="1"
export MOUND_GEM_OUT2_WIDTH_M="1"
export MOUND_GEM_OUT2_HEIGHT_M="1"
export MOUND_GEM_OUT2_Y_M="25"
export MOUND_GEM_OUT2_Z_M="1"
export MOUND_GEM_OUT3_WIDTH_M="1"
export MOUND_GEM_OUT3_HEIGHT_M="1"
export MOUND_GEM_OUT3_Y_M="26.04"
export MOUND_GEM_OUT3_Z_M="1"
...
export MOUND_SOURCE_CLEARANCE_M="2"
export MOUND_SOURCE_Z_MIN_M="0"
export MOUND_SOURCE_Z_MAX_M="1.3"
export MOUND_SOURCE_UPSTREAM_ARC_HALF_WIDTH_DEG="2"
...
export MOUND_SOURCE_DIRECTION_PHI_HALF_WIDTH_DEG="20"
